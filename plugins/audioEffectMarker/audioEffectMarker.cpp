...
{
	return "AudioEffectMarker";
}

extern "C" PluginType type()
{
	return PLUGIN_TYPE_AUDIO_EFFECT;
}
...
{
	return "Define the audio effects to be given to the specified position";
}

extern "C" void *attributeList()
{
	static std::vector<Attribute> attrs {
		{ "name", "string", "Effect name to set" },
